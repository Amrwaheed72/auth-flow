                ...
                <div className="flex flex-col justify-center p-8 md:p-14">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="focus:ring-opacity-50 w-full rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-600 focus:outline-none"
                        >
                            {isLoading ? (
